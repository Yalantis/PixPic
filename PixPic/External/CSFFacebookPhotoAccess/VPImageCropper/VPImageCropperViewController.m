...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [self performSelector:@selector(expandCropImageView) withObject:nil afterDelay:0.1f];
}
...
- (void)initView {
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(self.initialFrame.origin.x,
...
- (void)initControlBtn {
    ...
    [cancelBtn.titleLabel setFont:[UIFont fontWithName:@"Lato-Regular" size:18.0f]];
    ...
    [confirmBtn setTitle:@"Choose" forState:UIControlStateNormal];
    [confirmBtn.titleLabel setFont:[UIFont fontWithName:@"Lato-Regular" size:18.0f]];
