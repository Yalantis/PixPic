...
class EffectEditorView: UIView {
    ...
    private func setupDefaultAttributes() {
        ...
        let singleTap = UITapGestureRecognizer(target: self, action: #selector(EffectEditorView.singleTap(_:)))
        ...
        let panResizeGesture = UIPanGestureRecognizer(target: self, action: #selector(EffectEditorView.resizeTranslate(_:)))
